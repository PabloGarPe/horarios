...
export const MatematicasPage = () => {
  const cursos = [
    { label: "Primero", value: "matprimero" }, // Aquí ya viene el valor correcto
    { label: "Segundo", value: "matsegundo" },
    { label: "Tercero", value: "mattercero" },
    { label: "Cuarto", value: "matcuarto" }
  ];
