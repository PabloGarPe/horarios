...
export const MainBtn = ({children}) => {
   ...
   border-black border-2 rounded-none text-xl  hover:translate-x-0 hover:translate-y-0 transition-all font-mono font-bold -translate-x-2 -translate-y-2 ${clicked ? "btn-clicked" : "bg-white"} dark:text-white dark:bg-gray-700`}>
                {children}
            </span>
        </button>
    )
